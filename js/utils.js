        ...
        try {
            ...
            if (data.summary) {
                ...
                const summaryItems = [
                    ...
                    `Total Earnings: ${this.formatCurrency(data.summary.totalEarned)}`,
                    `Amount Paid: ${this.formatCurrency(data.summary.totalPaid)}`,
                    `Current Balance: ${this.formatCurrency(data.summary.currentBalance)}`,
            ...
            if (data.workRecords && data.workRecords.length > 0) {
                ...
                data.workRecords.forEach(record => {
                    ...
                    doc.text(record.status === 'completed' ? this.formatCurrency(record.wage) : '-', 140, yPos);
            ...
            if (data.payments && data.payments.length > 0) {
                ...
                data.payments.forEach(payment => {
                    ...
                    doc.text(this.formatCurrency(payment.amount), 60, yPos);
